...
class AnsibleCloudStackNetworkAclRule(AnsibleCloudStack):
    """AnsibleCloudStackNetworkAclRule"""
...
def main():
    ...
    anetwork_acl_rule = AnsibleCloudStackNetworkAclRule(module)

    state = module.params.get("state")
    if state == "absent":
        network_acl_rule = anetwork_acl_rule.absent_network_acl_rule()
    else:
        network_acl_rule = anetwork_acl_rule.present_network_acl_rule()

    result = anetwork_acl_rule.get_result(network_acl_rule)
