...
def main():
    ...
    anetwork_acl = AnsibleCloudStackNetworkAcl(module)

    state = module.params.get("state")
    if state == "absent":
        network_acl = anetwork_acl.absent_network_acl()
    else:
        network_acl = anetwork_acl.present_network_acl()

    result = anetwork_acl.get_result(network_acl)
