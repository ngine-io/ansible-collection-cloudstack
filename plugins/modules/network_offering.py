...
class AnsibleCloudStackNetworkOffering(AnsibleCloudStack):
    """AnsibleCloudStackNetworkOffering"""
...
def main():
    ...
    anetwork_offering = AnsibleCloudStackNetworkOffering(module)

    state = module.params.get("state")
    if state == "absent":
        network_offering = anetwork_offering.absent()
    else:
        network_offering = anetwork_offering.present()

    result = anetwork_offering.get_result(network_offering)
