...
def main():
    ...
    astorage_pool = AnsibleCloudStackStoragePool(module)

    state = module.params.get("state")
    if state in ["absent"]:
        pool = astorage_pool.absent_storage_pool()
    else:
        pool = astorage_pool.present_storage_pool()

    result = astorage_pool.get_result(pool)
