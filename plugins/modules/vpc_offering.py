...
def main():
    ...
    avpc_offering = AnsibleCloudStackVPCOffering(module)

    state = module.params.get("state")
    if state in ["absent"]:
        vpc_offering = avpc_offering.delete_vpc_offering()
    else:
        vpc_offering = avpc_offering.create_or_update()

    result = avpc_offering.get_result(vpc_offering)
