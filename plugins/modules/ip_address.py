...
def main():
    ...
    aip_address = AnsibleCloudStackIPAddress(module)

    state = module.params.get("state")
    if state in ["absent"]:
        ip_address = aip_address.disassociate_ip_address()
    else:
        ip_address = aip_address.present_ip_address()

    result = aip_address.get_result(ip_address)
